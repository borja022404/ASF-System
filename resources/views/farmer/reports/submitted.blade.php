        ...
        <div class="card-header bg-warning text-dark text-center py-4 ">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 text-center">
                    <h3 class="mb-1">
                        <i class="bi bi-exclamation-triangle-fill me-2"></i> Submitted Reports
                    </h3>
                    <p class="mb-0 fs-6 opacity-75">All new submitted that are waiting for inspection.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-4">
            @if ($submitted->isEmpty())
                <div class="alert alert-info text-center" role="alert">
                    <h4 class="alert-heading">No Submitted Reports</h4>
                    <p>There are no new submitted.</p>
                    <hr>
                    ...
                    <table class="table table-striped table-hover align-middle">
                        ...
                        <tbody>
                            @foreach ($submitted as $report)
                                <tr class="{{ $report->is_read_by_staff }}">
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-{{ $statusColor }}">
                                            <i class="bi bi-info-circle-fill me-1"></i>{{ ucfirst($report->report_status) }}
                                        </span>
                                    </td>
                                    <td>
